		...
		<title>Spare Sprit</title>
		      <?php
                  ...
                  printf("<link rel='stylesheet' type='text/css' href='css/mobile.css' media='screen and (max-width: 899px)' />");
						...
						printf("<link rel='stylesheet' media='all and (orientation:portrait)' href='mobile.css' />\n");
						printf("<link rel='stylesheet' media='all and (orientation:landscape)' href='desktop.css' />\n");
	...
	Favoriten
		...
		<div id="saeule">
		   <span class="tooltip tooltipUnten" data-tooltip-text="Standort ändern">
			<div id="ort">
				<input type="text" id="stadt" value="Ort eingeben" />	 <!--onchange="getCoordsByTown()"-->			
			</div> 
			</span>
		  ...
		  <span class="tooltip tooltipUnten" data-tooltip-text="Benzinsorte ändern"> 
		  	 ...
		  	 <span class="tooltip tooltipUnten" data-tooltip-text="Zur Tankstelle navigieren"> 
  		  	 <div id="route">
		   		<a target="_blank" href="" title="Zur Tankstelle navigieren" ><img src="img/routenplaner.jpg" width="75%" alt="" ></a>
		  	 </div>	
		  	 </span> 	  	 

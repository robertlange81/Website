...
// Zusätzlich wird die Funktion der Färbung aufgerufen.
  ...
  function pruefeFormular(f) {
    ...
    if (f.elements["captcha"].value == c) {
      return true;
    } else {
      alert("Falsche Eingabe Captcha!\n\n");
      return false;
    }
  }
 
  function berechneCaptcha() {
		a = zufallszahl();
		b = zufallszahl();
		c = a*b
  }   
...
<!--<script type="text/javascript">berechneCaptcha();document.write("<p>Are You human? Verification: " + a + " * " + b + " = <input name='captcha' type='text' id='captcha' name='captcha' value='0' required>");</script>-->
...
require_once('recaptchalib.php');
			...
			$publickey = "6LeHH-MSAAAAAH6RnziEXgeAs-xpvFqJUj6c_y9h"; // Public Key
			$privatekey = "6LeHH-MSAAAAAJpiVeuhdtuq_jRljlrlivG9y_v5"; // Private Key
